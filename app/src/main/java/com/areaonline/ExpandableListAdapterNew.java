...
public class ExpandableListAdapterNew extends BaseExpandableListAdapter {
    ...
    public ExpandableListAdapterNew(Context context
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        if (convertView == null) {
            ...
            if (header.getTitle().equalsIgnoreCase("Help")){
              LinearLayout line_line = convertView.findViewById(R.id.line_line);
              line_line.setVisibility(View.VISIBLE);
            }
        }
