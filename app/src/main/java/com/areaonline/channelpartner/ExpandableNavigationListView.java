package com.areaonline.channelpartner;
...
import com.areaonline.ExpandableListAdapterNew;
...
public class ExpandableNavigationListView extends ExpandableListView {
    ...
    public ExpandableNavigationListView build(){
        expandableListAdapter = new ExpandableListAdapterNew(this.context, this.listHeader);
